  ...
  const loadMessages = React.useCallback(
    async (
      ...
      if (folder === 'agent' && !defaultAgentDid) {
        setError('No default agent DID found. Create or select a default ATP agent first.');
        return;
      }
    ...
    <main>
      <Box sx={{ px: 3, py: 3 }}>
        ...
        <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
          View and send messages between your wallet and agents, and see messages directed to your default ATP agent.
        </Typography>
